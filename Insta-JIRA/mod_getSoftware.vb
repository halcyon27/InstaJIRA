...
clearSoftware:
    ...
    Public Sub vlSetHostUrl()
        ...
        hostUrl = ""
        If serverEnv = "QATEST" Then hostUrl = "http://10.5.13.121:8080/asr/status"
        If serverEnv = "QADMZ" Then hostUrl = "http://10.5.252.158:8080/asr/status"
        If serverEnv = "QATEST3" Then hostUrl = "http://10.5.252.158:8080/asr/status"
